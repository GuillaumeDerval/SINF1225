...
public class City
{
	 ...
	 *            Name of the city
	 * @param country
	 *            Country(entire name, in french, like Belgique)
	 * @param loc
	 *            Location of the city
	 * @param restaurantsID
	 *            restaurantIDs which are in this city.
	 */
	 ...
	 * 
	 * @param location
	 *            Location from which calculate distance
	 ...
	 *            Location from which calculate distance
	 * @param howmuch
	 *            max number of restaurant to get
