...
/**
 * Layer between the models classes and the database. ONLY models should access to this class! NO verification will be done on rights!
 * 
...
class GourmetDatabase extends SQLiteOpenHelper
{
	 ...
	 * 
	 * @param context
	 *            Context which call the database
	 */
	...
	{
		int[] ressources = { R.drawable.picture1, R.drawable.picture2, R.drawable.picture3, R.drawable.alterezvous1, R.drawable.alterezvous2, R.drawable.alterezvous3, R.drawable.alterezvous4, R.drawable.mousse_alterezvous, R.drawable.quichepoireaux_alterezvous, R.drawable.soupe_alterezvous, R.drawable.armes1, R.drawable.armes2, R.drawable.armes3, R.drawable.armes4, R.drawable.quai1, R.drawable.quai2, R.drawable.quai3, R.drawable.quai_asp_saum, R.drawable.quai_couteaux, R.drawable.quai_feuille, R.drawable.quai_gourmand, R.drawable.quai_grandlarge, R.drawable.quai_turbo, R.drawable.madzebu_carpboeuf, R.drawable.madzebu_salade, R.drawable.madzebu_simenthal, R.drawable.madzebu_vitello, R.drawable.madzebu_dame, R.drawable.madzebu_creme };
		String[] links = { "img/picture1.png", "img/picture2.png", "img/picture3.png", "img/alterezvous1.png", "img/alterezvous2.png", "img/alterezvous3.png", "img/alterezvous4.png", "img/mousse_alterezvous.png", "img/quichepoireaux_alterezvous.png", "img/soupe_alterezvous.png", "img/armes1.png", "img/armes2.png", "img/armes3.png", "img/armes4.png", "img/quai1.png", "img/quai2.png", "img/quai3.png", "img/quai_asp_saum.png", "img/quai_couteaux.png", "img/quai_feuille.png", "img/quai_gourmand.png", "img/quai_grandlarge.png", "img/quai_turbo.png", "img/madzebu_carpboeuf.png", "img/madzebu_salade.png", "img/madzebu_simenthal.png", "img/madzebu_vitello.png", "img/madzebu_dame.png", "img/madzebu_creme.png" };
	...
	/**
	 * Return images corresponding to this object. Private, because models should not be aware of the sqlite database and how data is stocked inside.
	 * 
	 * @param objectType
	 * @param objectId
	 * @return list of images
	...
	private List<Image> getImages(String objectType, int objectId)
	{
		...
		{
			Image image = new Image(cursor.getString(0), cursor.getString(1), cursor.getString(2), cursor.getInt(3));
	...
	public Dish getDish(int dishId)
	{
		...
		Cursor cursor = db.query("dish", // table to select on
				new String[] { "dishId", "name", "restoId", "description", "price", "spicy", "vegan", "available", "allergen", "category" },// column
																																			// to get
		...
		Dish dish = new Dish(cursor.getInt(0), // dishId
	...
	public List<Dish> getDishInRestaurant(Restaurant restaurant)
	{
		...
		Cursor cursor = db.query(true, "dish", // table to select on
				new String[] { "dishId", "name", "restoId", "description", "price", "spicy", "vegan", "available", "allergen", "category" },// column
																																			// to get
				"`restoId` = ?", new String[] { Integer.valueOf(restaurant.getId()).toString() }, null, null, null, null);
		...
		for (int j = 0; j < cursor.getCount(); j++)
		{
			List<Image> imgs = getImages("dish", cursor.getInt(0));
			Image img = imgs.size() == 0 ? null : imgs.get(0);
			Dish dish = new Dish(cursor.getInt(0), cursor.getString(1), cursor.getInt(2), cursor.getString(3), cursor.getDouble(4), cursor.getInt(5) == 1, cursor.getInt(6) == 1, cursor.getInt(7), cursor.getString(8), cursor.getString(9), restaurant, img);
	...
	public Restaurant getRestaurant(int restoId)
	{
		...
		Cursor cursor = db.query("restaurant", // table to select on
				new String[] { "restoId", "name", "cityName", "cityCountry", "address", "priceCat", "longitude", "latitude", "phone", "seats", "website", "description", "stars", "email" },// column
																																															// to
																																															// get
		...
		Restaurant resto = new Restaurant(cursor.getInt(0), // id
	...
	public List<Restaurant> getRestaurantsInCity(City city)
	{
		...
		Cursor cursor = db.query(true, "restaurant", // table to select on
				new String[] { "restoId", "name", "cityName", "cityCountry", "address", "longitude", "latitude", "description", "email", "stars", "phone", "website", "seats", "priceCat" }, // column
																																																// to
																																																// get
				"`cityName` = ? AND `cityCountry` = ?", new String[] { city.getName(), city.getCountry() }, null, null, null, null);
		if (cursor == null)
		{
			return null;
		}
		...
		for (int j = 0; j < cursor.getCount(); j++)
		{
			...
			Restaurant resto = new Restaurant(cursor.getInt(0), city, cursor.getString(1), cursor.getString(4), PriceCategory.values()[cursor.getInt(13)], loc, cursor.getString(10), cursor.getInt(12), cursor.getString(11), cursor.getString(7), cursor.getInt(9), cursor.getString(8));
	...
	public Reservation getReservation(String userEmail, int restoId, Date date)
	{
		...
		Cursor cursor = db.query("reservation", // table to select on
				new String[] { "resvId", "nbrReservation" }, "`userEmail` = ? AND `restoId` = ? AND `date` = ?", // where
				str, // where string
				null, // group by
				null, // having
				null); // orderby
		...
		cursor = db.query("reservationDish", // table to select on
				new String[] { "dishId" }, "`resvId` = ?", // where
	 ...
	 * 
	 * @param user
	 *            The user from who you want all the reservations
	 * */
	public List<Reservation> getReservationByUser(User user)
	{
		...
		Cursor cursor = db.query(true, "reservation", // table to select on
				...
				"`UserEmail` = ?", new String[] { user.getEmail() }, null, null, null, null);
		if (cursor == null)
		{
			return null;
		}
	...
	public Preference getPrefByUserEmail(String userEmail)
	{
		...
		Cursor cursor = db.query(true, "preferences", // table to select on
				...
				"`email` = ?", new String[] { userEmail }, null, null, null, null);
		if (cursor == null || cursor.getCount() == 0)
		{
			return null;
		}
