...
public class GourmetUtils
{
	...
	/**
	 * Create a standard menu for this activity. Activity should redirect onOptionsItemSelected to GourmetUtils.onMenuItemSelected to let this work.
	 * 
	 * @param menu
	 * @param view
	 * @param nowId
	 *            Ressource of the menu this activity is currently in.
	 */
	 ...
	 * 
	 * @param context
	 *            Context from which function is called
	 * @param ressourceId
	 *            Raw ressource id to read
