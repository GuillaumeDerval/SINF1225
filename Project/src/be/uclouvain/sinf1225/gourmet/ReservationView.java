...
public class ReservationView extends Activity {
	...
	private static final String DATEFORMAT = "EEE, dd MMM yyyy";
	private static final String TIMEFORMAT = "HH:mm a";
	protected static SimpleDateFormat dateFormatter = new SimpleDateFormat(DATEFORMAT);
	protected static SimpleDateFormat timeFormatter = new SimpleDateFormat(TIMEFORMAT);
